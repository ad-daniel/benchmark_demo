...
Stuff happens, happiness ensues.
...
Click on the "Add people" and search for "ad-daniel". When you found the organizer, add them to the repository.
...
1. [Click here](https://github.com/ad-daniel/benchmark_demo/issues/new?assignees=&labels=registration&template=registration_form.yml&title=Registration+to+benchmark) to go to the organizer repository and start your registration. If it doesn't work, you can do it manually by going to the organizer's repository, then to the "Issues" tab, creating a new issue and choosing "Registration to benchmark".
